...
public class BlogServiceImpl implements BlogService {
	...
	/*
	 * public Boolean (Long id) { Optional<BlogEntity> exists =
	 * blogRepository.findById(id); if(exists.isPresent()) {
	 * blogRepository.deleteById(id); return true; } throw new
	 * BlogNotFoundException("Blog not found for ID: "+id); }
	 */
