...
<head>
    ...
    <title>User Account - Banking System</title>
    <!-- Bootstrap CSS -->
...
<div class="container">
    <div class="card p-4">
        ...
        <form action="requestdetails" method="post">
            <div class="mb-3">
                <label for="username" class="form-label">Bank-ID</label>
            ...
            <button type="submit" class="btn btn-custom w-100" name="action" value="login">Login</button>
        </form>
    </div>
</div>
