...
import com.wipro.customer.config.BankClient;
...
public class CustomerService {
    ...
    public APIResponseDTO getCustomerByBankId(String bankId) {
        ...
        // Use the Feign client to fetch the BankDTO
        BankDTO bankDTO = bankClient.getBankByCustomerBankId(cust.getCustomerBankId());
